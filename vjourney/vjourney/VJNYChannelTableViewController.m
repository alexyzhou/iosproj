//
//  VJNYChannelTableViewController.m
//  vjourney
//
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([_parent isMemberOfClass:[VJNYWhatsNewViewController class]]) {
        [[VJNYWhatsNewViewController instance] enterVideoPageByChannelID:((VJNYPOJOChannel*)[_data objectAtIndex:indexPath.row]).cid AndTitle:((VJNYPOJOChannel*)[_data objectAtIndex:indexPath.row]).name];
